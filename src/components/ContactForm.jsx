        ...
        <form onSubmit={handleFormSubmit} className="space-y-6 reveal">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="group">
              ...
              <input required type="text" className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder-white/20 outline-none focus:border-[#D4AF37]/50 focus:bg-white/[0.05] transition-all" placeholder="Your name" />
            </div>
            <div className="group">
              ...
              <input required type="email" className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder-white/20 outline-none focus:border-[#D4AF37]/50 focus:bg-white/[0.05] transition-all" placeholder="you@company.com" />
            </div>
          </div>
          <div className="group">
            ...
            <textarea required rows={5} className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder-white/20 outline-none focus:border-[#D4AF37]/50 focus:bg-white/[0.05] transition-all resize-none" placeholder="Tell me about your project..."></textarea>
          </div>
          <button type="submit" className="w-full py-4 bg-[#D4AF37] text-black text-xs tracking-[0.2em] uppercase font-bold hover:shadow-[0_0_40px_rgba(212,175,55,0.3)] transition-all duration-300 flex items-center justify-center gap-2">
